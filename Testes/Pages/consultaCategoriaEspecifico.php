<?php
    ...
    $buscarCategoria = $categorias->buscarNome($_POST['nomeCategoria']);
...
<body>
    ...
    <form action="consultaCategoriaEspecifico.php" method="post">
              ...
              <button class="btn btn-danger w-15 py-2 mt-3" name="buscar" type="submit">Buscar</button></form><a href="consultaCategoria.php"><button class="btn btn-success w-15 py-2 mt-3">Voltar</button></a>
              </form>
              </div>
              <hr>
        </div>
    ...
    <div class="container">
        <table class="table">
            ...
            <?php
                    foreach($buscarCategoria as $categoria): ?>
                    <tr>
