<?php
    ...
    $Medidas = new MedidaFuncoes($pdo);
    $buscarMedida = $Medidas->buscarNome($_POST['nomeMedida']);
...
<body>
    ...
    <div class= "container mt-3">
        <div class="row">
            <div class = col-2>
            <h3>Consulta - Medida</h3>
            </div>
            <div>        

    <form action="consultaMedidaEspecifico.php" method="post">
              <input type="text" name="nomeMedida" >
              <button class="btn btn-danger w-15 py-2 mt-3" name="buscar" type="submit">Buscar</button></form><a href="consultaMedida.php"><button class="btn btn-success w-15 py-2 mt-3">Voltar</button></a>
              </form>
              </div>
              <hr>
        </div>
    ...
    <div class="container">
        <table class="table">
            <thead>
                ...
                <!--<th scope="col">Nome do Medida</th>-->
            ...
            <?php
                    foreach($buscarMedida as $Medida): ?>
                    <tr>
                        ...
                        <td scope="col"><a href=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search " viewBox="0 0 16 16">
                            ...
                            <!--EXCLUIR CONTATO -->
                            <td scope="col"><a name="inativar" href="inativarMedida.php?idMedida=<?= $Medida->getIdMedida() ?>">
                            <input type="hidden" name="idMedida" value="<?= $Medida->getIdMedida() ?>">
