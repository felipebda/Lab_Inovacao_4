...
<body>
    ...
    <div class="container col-4">
        <main class="form-signin w-100 m-auto">
            <form action="../Validation/validaCadastroMedida.php" method="post">
            ...
            <path d="M10 .5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5.5.5 0 0 1-.5.5.5.5 0 0 0-.5.5V2a.5.5 0 0 0 .5.5h5A.5.5 0 0 0 11 2v-.5a.5.5 0 0 0-.5-.5.5.5 0 0 1-.5-.5Z"/>
              ...
              <h1 class="h3 mb-3 fw-normal">Informe nome da nova medida</h1>
                ...
                <label for="floatingInput">Nome da Medida </label>
                </div>

                <input type="hidden" name="ativo" value="1" checked>
