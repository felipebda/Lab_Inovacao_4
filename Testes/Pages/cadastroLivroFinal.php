...
//PEGAR RECEITAS VINCULADAS AO LIVRO
...
<body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class=" text-center">
          <h2>Cadastro de Livro concluido!</h2>
        </div>
      </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-5"></div>
            <div class="col-2">
                <a href="secaoEdit.php"><button type="button" class="btn btn-primary">Voltar a tela inicial</button></a>
            </div>
