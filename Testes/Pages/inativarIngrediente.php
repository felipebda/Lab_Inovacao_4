<?php
    ...
    $idIngrediente = intval($_POST['excluirIngrediente']);
    //echo $idCargo;
...
<body>
    ...
    <div class="container col-4">
        <main class="form-signin w-100 m-auto">
            <form action="../Validation/validaExcluirIngrediente.php" method="post">
            ...
            <path d="M10 .5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5.5.5 0 0 1-.5.5.5.5 0 0 0-.5.5V2a.5.5 0 0 0 .5.5h5A.5.5 0 0 0 11 2v-.5a.5.5 0 0 0-.5-.5.5.5 0 0 1-.5-.5Z"/>
              ...
              <h1 class="h3 mb-3 fw-normal">Este ingrediente será inativado</h1>

                <div class="form-floating rounded-top">
                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="nome_cargo" value =<?php echo "'".$resultado["nome"]."'"; ?> readonly>
                <label for="floatingInput">Nome do Ingrediente </label>
                </div>

                <div class="form-floating rounded-top">
                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="nome_cargo" value =<?php echo "'".$resultado["descricao"]."'"; ?> readonly>
                <label for="floatingInput">Descrição do Ingrediente </label>
                </div>

                <input type="hidden" name="tipo_excluir" value =<?php echo "'".$resultado["idIngrediente"]."'"; ?>>
