...
<body>
    ...
    <div class="container mt-3">
        ...
        <form action="../Validation/validaInsercaoImagemReceita.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-3"></div>
                <div class="col-6 d-flex justify-content-center align-items-center">
                    ...
                    <input type="hidden" id="idReceita" name="idReceita" value=<?php echo$idReceitaSession; ?>>
